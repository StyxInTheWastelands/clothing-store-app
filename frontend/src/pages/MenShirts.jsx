...
function MenShirts() {
  usePageMeta('Koszulki męskie', 'Koszulki i topy z kolekcji męskiej Urban Stitch.');
    ...
    fetch(`${API_URL}/api/products`)
      ...
      .then((data) => {
        ...
        const filteredProducts = allProducts.filter(product => {
          ...
          // Ta sama tolerancyjna reguła co w MenPants.jsx, bo dane w bazie mają niespójne wartości płci
          const isMen =
          ...
          const isShirtCategory = Number(categoryIdField) === 1;

          return isMen && isShirtCategory;
        });

        setProducts(filteredProducts);
      })
      .catch((err) => console.error("Błąd ładowania koszulek męskich:", err))
        ...
        <div style={{
          ...
          {products.length > 0 ? (
            ...
            <div style={{ gridColumn: '1 / -1', textAlign: 'center', padding: '40px' }}>
              <p style={{ color: '#6b7280' }}>Obecnie nie ma dostępnych koszulek męskich.</p>
            </div>
          )}
        </div>
      </div>
