...
function WomenShirts() {
  usePageMeta('Koszulki damskie', 'Koszulki i topy z kolekcji damskiej Urban Stitch.');
    ...
    fetch(`${API_URL}/api/products`)
      ...
      .then((data) => {
        ...
        const filteredProducts = allProducts.filter(product => {
          ...
          const isWomen = genderValue === 'women';
          ...
          return isWomen && isShirtCategory;
        });

        setProducts(filteredProducts);
      })
      .catch((err) => console.error("Błąd ładowania koszulek damskich:", err))
        ...
        <div style={{
          ...
          {products.length > 0 ? (
            ...
            <div style={{ gridColumn: '1 / -1', textAlign: 'center', padding: '40px' }}>
              <p style={{ color: '#6b7280' }}>Obecnie nie ma dostępnych koszulek damskich.</p>
            </div>
          )}
        </div>
      </div>
