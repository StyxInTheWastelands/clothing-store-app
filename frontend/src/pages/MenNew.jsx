...
function MenNew() {
  usePageMeta('Nowości męskie', 'Najnowsze produkty z kolekcji męskiej Urban Stitch.');
    ...
    fetch(`${API_URL}/api/products`)
      ...
      .then((data) => {
        ...
        const menProducts = allProducts.filter(product => {
          ...
          // Porównujemy z rzeczywistą wartością w bazie ('men') oraz starym wariantem 'męski'
          return genderValue === 'men' || genderValue === 'męski';
        });

        setProducts(menProducts);
      })
      .catch((err) => console.error("Błąd ładowania nowości męskich:", err))
        ...
        <div style={{
          ...
          {products.length > 0 ? (
            ...
            <div style={{ gridColumn: '1 / -1', textAlign: 'center', padding: '40px' }}>
              <p style={{ color: '#6b7280' }}>Obecnie nie ma nowych produktów dla mężczyzn.</p>
            </div>
          )}
        </div>
      </div>
