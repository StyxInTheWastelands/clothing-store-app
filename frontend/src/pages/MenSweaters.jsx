...
function MenSweaters() {
  usePageMeta('Bluzy i swetry męskie', 'Bluzy i swetry z kolekcji męskiej Urban Stitch.');
  ...
  useEffect(() => {
    ...
    fetch(`${API_URL}/api/products`)
      ...
      .then((data) => {
        ...
        // Filtrowanie: płeć męska + category_id === 5 (bluzy i swetry)
        const filteredProducts = allProducts.filter(product => {
          ...
          const isMen =
            ...
            genderValue.startsWith('me') || 
            genderValue.startsWith('mę') || 
          ...
          return isMen && isSweaterCategory;
        });

        setProducts(filteredProducts);
      })
      .catch((err) => console.error("Błąd ładowania bluz i swetrów męskich:", err))
        ...
        <div style={{
          ...
          {products.length > 0 ? (
            ...
            <div style={{ gridColumn: '1 / -1', textAlign: 'center', padding: '40px' }}>
              <p style={{ color: '#6b7280' }}>Obecnie nie ma dostępnych bluz ani swetrów męskich.</p>
            </div>
          )}
        </div>
      </div>
