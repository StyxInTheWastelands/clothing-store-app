...
function MenJackets() {
  usePageMeta('Kurtki męskie', 'Kurtki z kolekcji męskiej Urban Stitch.');
  ...
  useEffect(() => {
    ...
    fetch(`${API_URL}/api/products`)
      ...
      .then((data) => {
        ...
        // Filtrowanie: płeć męska + category_id === 4 (kurtki)
        const filteredProducts = allProducts.filter(product => {
          ...
          return isMen && isJacketCategory;
        });

        setProducts(filteredProducts);
      })
      .catch((err) => console.error("Błąd ładowania kurtek męskich:", err))
        ...
        <div style={{
          ...
          {products.length > 0 ? (
            ...
            <div style={{ gridColumn: '1 / -1', textAlign: 'center', padding: '40px' }}>
              <p style={{ color: '#6b7280' }}>Obecnie nie ma dostępnych kurtek męskich.</p>
            </div>
          )}
        </div>
      </div>
